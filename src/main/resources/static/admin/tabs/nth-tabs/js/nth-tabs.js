...
(function ($) {
    ...
    $.fn.nthTabs = function (options) {
        ...
        var defaults = {
            ...
            iframeAttr: ' width="100%" height="900" frameborder="0" marginheight="0" marginwidth="0" border="false" scrolling="no" ',//iframe 的属性
        ...
        var template =
            ...
            '<ul class="dropdown-menu nth-tabs-dropdown-menu">' +
        ...
        var methods = {
            ...
            addTab: function (options) {
                ...
                if(url.length>0){
                    tabContent.push('<iframe '+settings.iframeAttr+' src="'+options.url+'" frameborder="0" name="iframe-'+frameName+'" class="nth-tabs-frame"></iframe>');
                    frameName++;
                }else{
